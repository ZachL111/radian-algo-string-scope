"""Regression checks for the radian-algo-string-scope casebook."""
...
from casebook.harness import assert_expected, radian_algo_string_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(radian_algo_string_scope_summary(), assert_expected())
